...
class SwipeHelperCallback : ItemTouchHelper.Callback() {
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder) : View {
        return (viewHolder as ScheduleAdaptar.ViewHolder).itemView.findViewById(R.id.schedule_layout)
    }

    fun setClamp(context:Context, clamp: Float) {
        this.clamp = ConvertDPtoPX(context, clamp)
    }
    //dp -> px
    ...
    fun removePreviousClamp(recyclerView: RecyclerView) {
        ...
        previousPosition?.let {
            ...
            Log.d("swipe", "viewHolder not null")
